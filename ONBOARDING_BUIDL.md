...
**No video needed.** Luca, in Discord: *"For the bounty a video isn't required. If a short
clip helps explain your teardown you're welcome to add one, but it's optional. Just make
sure your submission clearly links the actual deliverable."* The DoraHacks form marks the
field required anyway; the deliverable links sit in the first and second paragraphs.

Logo: `site/onboarding-logo.png`, 480x480, generated by `site/build_onboarding_logo.py`.
